...
- [내장 OAuth 제공자 사용하기](https://nextauth-ko.wsbox.pw/configuration/providers/oauth#built-in-providers) (예: Github, Twitter, Google 등)
- [사용자 정의 OAuth 제공자 사용하기](https://nextauth-ko.wsbox.pw/configuration/providers/oauth#using-a-custom-provider)
...
내장된 제공자를 사용하는 경우, 대개 `clientId`와 `clientSecret`만 지정하면 됩니다. 기본값을 재정의해야 할 경우, [옵션](https://nextauth-ko.wsbox.pw/configuration/providers/oauth#options)을 추가하세요.
