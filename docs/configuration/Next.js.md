...
## `getServerSession`[](https://nextauth-ko.wsbox.pw/configuration/nextjs#getserversession "헤딩으로 직접 링크")
...
### `getServerSideProps`에서:[](https://nextauth-ko.wsbox.pw/configuration/nextjs#in-getserversideprops "헤딩으로 직접 링크")
...
### API 라우트에서:[](https://nextauth-ko.wsbox.pw/configuration/nextjs#in-api-routes "헤딩으로 직접 링크")
...
### 앱 라우터에서:[](https://nextauth-ko.wsbox.pw/configuration/nextjs#in-app-router "헤딩으로 직접 링크")
...
:::
### 캐싱[](https://nextauth-ko.wsbox.pw/configuration/nextjs#caching "헤딩으로 직접 링크")
...
## `unstable_getServerSession`[](https://nextauth-ko.wsbox.pw/configuration/nextjs#unstable_getserversession "헤딩으로 직접 링크")

이 메서드는 `getServerSession`으로 이름이 변경되었습니다. 위의 문서를 참조하세요.

## 미들웨어[](https://nextauth-ko.wsbox.pw/configuration/nextjs#middleware "헤딩으로 직접 링크")
...
다음 옵션들이 익숙하게 보인다면, 이는 [이 옵션들](https://nextauth-ko.wsbox.pw/configuration/options#options)의 하위 집합이기 때문입니다. 이를 공통 구성 객체로 추출하여 재사용할 수 있습니다. 미래에는 모든 것을 미들웨어에서 실행할 수 있기를 바랍니다. ([제한 사항](https://nextauth-ko.wsbox.pw/configuration/nextjs#caveats)을 참조하세요).

`next-auth/middleware`에서 `withAuth` 미들웨어 함수를 기본 또는 명명된 가져오기 방식으로 가져올 수 있습니다:

### 필수 조건[](https://nextauth-ko.wsbox.pw/configuration/nextjs#prerequisites "헤딩으로 직접 링크")

미들웨어에서 사용하는 `secret`을 NextAuth에서도 동일하게 설정해야 합니다. 가장 쉬운 방법은 [`NEXTAUTH_SECRET`](https://nextauth-ko.wsbox.pw/configuration/options#nextauth_secret) 환경 변수를 설정하는 것입니다. 이는 [NextAuth 구성](https://nextauth-ko.wsbox.pw/configuration/options#options)과 미들웨어 구성 모두에서 사용됩니다.

또는, 미들웨어 구성에서 [`secret`](https://nextauth-ko.wsbox.pw/configuration/nextjs#secret) 옵션을 사용하여 비밀을 제공할 수도 있습니다.

**강력히 권장**합니다. `secret` 값을 완전히 `NEXTAUTH_SECRET` 환경 변수로 대체하세요.

### 기본 사용법[](https://nextauth-ko.wsbox.pw/configuration/nextjs#basic-usage "헤딩으로 직접 링크")
...
### `callbacks`[](https://nextauth-ko.wsbox.pw/configuration/nextjs#callbacks "헤딩으로 직접 링크")

- **필수:** 아니오

#### 설명[](https://nextauth-ko.wsbox.pw/configuration/nextjs#description "헤딩으로 직접 링크")

콜백은 특정 작업이 수행될 때 일어나는 일을 제어할 수 있는 비동기 함수입니다.

#### 예제 (기본 값)[](https://nextauth-ko.wsbox.pw/configuration/nextjs#example-default-value "헤딩으로 직접 링크")
...
### `pages`[](https://nextauth-ko.wsbox.pw/configuration/nextjs#pages "헤딩으로 직접 링크")

- **필수**: _아니오_

#### 설명[](https://nextauth-ko.wsbox.pw/configuration/nextjs#description-1 "헤딩으로 직접 링크")
...
#### 예제 (기본 값)[](https://nextauth-ko.wsbox.pw/configuration/nextjs#example-default-value-1 "헤딩으로 직접 링크")
...
### `secret`[](https://nextauth-ko.wsbox.pw/configuration/nextjs#secret "헤딩으로 직접 링크")

- **필수:** _아니오_

#### 설명[](https://nextauth-ko.wsbox.pw/configuration/nextjs#description-2 "헤딩으로 직접 링크")

동일한 `secret`이 [NextAuth.js 구성](https://nextauth-ko.wsbox.pw/configuration/options#options)에서도 사용됩니다.

#### 예제 (기본 값)[](https://nextauth-ko.wsbox.pw/configuration/nextjs#example-default-value-2 "헤딩으로 직접 링크")
...
### 고급 사용법[](https://nextauth-ko.wsbox.pw/configuration/nextjs#advanced-usage "헤딩으로 직접 링크")
...
:::
#### 미들웨어 래핑[](https://nextauth-ko.wsbox.pw/configuration/nextjs#wrap-middleware "헤딩으로 직접 링크")
...
#### 커스텀 JWT 디코드 메서드[](https://nextauth-ko.wsbox.pw/configuration/nextjs#custom-jwt-decode-method "헤딩으로 직접 링크")
...
### 주의 사항[](https://nextauth-ko.wsbox.pw/configuration/nextjs#caveats "헤딩으로 직접 링크")
...
- `"jwt"` [세션 전략](https://nextauth-ko.wsbox.pw/configuration/options#session)만 지원합니다. 엣지에서 데이터베이스가 충분히 성숙해져 빠른 경험을 보장할 수 있을 때까지 기다려야 합니다. (엣지 호환 데이터베이스를 알고 있다면, 새로운 [어댑터](https://authjs.dev/guides/creating-a-database-adapter)를 제안해 주세요.)